...
<flow-definition plugin="workflow-job@2.41">
  ...
  <definition class="org.jenkinsci.plugins.workflow.cps.CpsFlowDefinition" plugin="workflow-cps@2.93">
    ...
    stages {
        stage(&apos;Checkout&apos;) {
            steps {
                git branch: &apos;main&apos;, url: &apos;https://github.com/OpenCloudCX/opencloudcx-app-kaniko.git&apos;
            }   
        }
        stage(&apos;Build docker image and publish&apos;) {
            steps {
                ...
                ./kubectl wait --for=condition=Ready pod/opencloudcx-demo-app-build --namespace jenkins --timeout=300s
                sleep 30
                ./kubectl delete pods --namespace jenkins opencloudcx-demo-app-build
